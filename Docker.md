# 🐳 Docker — Part 1 : Concepts & How It Works
...
|Step|Topic|Why|
|---|---|---|
|1|**Images**|Understand what you're running|
|2|**Containers**|Learn to run & manage them|
|3|**Ports**|Connect app to your browser|
|4|**Logs**|Debug what's happening inside|
|5|**Volumes**|Persist data across restarts|
|6|**Dockerfile**|Build your own custom images|
|7|**Docker Compose**|Orchestrate multi-service apps|
...
✅ If a webpage loads — you just deployed your first container!
...
_Tags: #docker #devops #containers #concepts_
